...
public class CtrlCenterHandler extends ChannelInboundHandlerAdapter {
	...
	private void playerStatusResp(byte[] content) {
		...
		for (int i = 0; i < Hall.uniqueHall().roomList.size(); i++) {
			playerStatus = Hall.uniqueHall().roomList.get(i).gamerGroup.playerExist(playerStausProtoReq.getPlayerId());
			if (playerStatus > 0) {
				break;
			}
		}
		...
		// playerStatus =
		// ChannelHandler.roomKnockList.get(i).playerExist(playerStausProtoReq.getPlayerId());
		// if (playerStatus > 0) {
		// break;
		// }
		// }
		...
		// playerStatus =
		// ChannelHandler.roomImperialList.get(i).playerExist(playerStausProtoReq.getPlayerId());
		// if (playerStatus > 0) {
		// break;
		// }
		// }
		...
		// playerStatus =
		// ChannelHandler.roomOmahaList.get(i).playerExist(playerStausProtoReq.getPlayerId());
		// if (playerStatus > 0) {
		// break;
		// }
		// }
